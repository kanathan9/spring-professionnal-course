...
public class LoggingAspect {
  ...
  @Before("execution(* com.simplexarchitect.learn.springprofessional.lecon1_1.DateService.*(..))")
  public void logBefore() {
    logger.debug("Logging BEFORE method execution");
  }

  @After("execution(* com.simplexarchitect.learn.springprofessional.lecon1_1.DateService.*(..))")
  public void logAfter() {
    logger.debug("Logging AFTER method execution");
  }

  @Around("execution(* com.simplexarchitect.learn.springprofessional.lecon1_1.DateService.*(..))")
